...
export default function AutorizadorPendientes() {
  ...
  const columns: Column<SalidaVehiculo>[] = [
    ...
    { key: 'motivo_salida', header: 'Motivo', render: s => <span className="text-slate-500 truncate max-w-[180px] block">{s.motivo_salida}</span> },
        ...
        {detalle && (
          <div className="space-y-2 text-sm">
            <div className="grid grid-cols-2 gap-x-6 gap-y-2">
              ...
              <div className="col-span-2"><span className="text-slate-500">Motivo:</span> <span className="ml-1">{detalle.motivo_salida}</span></div>
